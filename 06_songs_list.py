...
summ_of_three_songs = round(
    violator_songs_list[3][1] +
    violator_songs_list[5][1] +
    violator_songs_list[-1][1], 2
)
print('Три песни звучат', summ_of_three_songs, 'минут')
...
print('А другие три песни звучат', summ_of_three_songs, 'минут')
